...
class1.add_student(gleb)
class2.add_student(dima)
class2.add_student(andriiko)

teacher_1 = Teacher("Albina" , "Programming" , class2)
teacher_2 = Teacher("Lyolik" , "Humour" , class1)
...
for class_obj in my_school.classes:
    print("Класи які наявні у школі :" , class_obj.number)
for teacher in my_school.teachers:
    print("Вчителі у школі: ", teacher.name)
